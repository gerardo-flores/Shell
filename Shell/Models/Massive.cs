...
namespace Shell.Models
{
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        /// </summary>
        public virtual dynamic Paged(string join = "", string where = "", string orderBy = "", string columns = "*", int pageSize = 20, int currentPage = 1, params object[] args)
        {
            ...
            if (_providerName == "System.Data.SqlServerCE.4.0")
            {
                ...
                sql = string.Format("SELECT {0} FROM {1} {2} {6} ORDER BY {3} OFFSET {4} ROWS FETCH NEXT {5} ROWS ONLY", columns, TableName, where, orderBy, pageNum, pageSize, join);
            }
            else
            {
